...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TheUntitledTestCaseTest()
        {
            ...
            string rand = "user" + (Math.Round(random.NextDouble(), 3)*1000).ToString();
            ...
            driver.FindElement(By.Id("Email")).SendKeys(rand+"@ferit.hr");
            driver.FindElement(By.Id("Password")).Click();
            driver.FindElement(By.Id("Password")).Clear();
            driver.FindElement(By.Id("Password")).SendKeys("ferit345");
            driver.FindElement(By.Id("ConfirmPassword")).Click();
            driver.FindElement(By.Id("ConfirmPassword")).Clear();
            driver.FindElement(By.Id("ConfirmPassword")).SendKeys("ferit345");
